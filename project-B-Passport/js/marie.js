...
class Particle {
  constructor(x, y) {
    this.x = constrain(x, width / 2 - 180, width / 2 + 180);
    this.y = constrain(y, height / 2 - 180, height / 2 + 180);
